    ...
    <div className="mb-6">
      ...
      {Array.isArray(points) && points.length > 0 ? (
        ...
        <div className="text-sm text-muted-foreground bg-muted/50 rounded-md p-4">
          <div className="mb-2">
            No {typeof title === "string" ? title.toLowerCase() : "items"} found
          </div>
          <RetryButton />
        </div>
      )}
                  ...
                  <Sheet>
                    ...
                    >
                      <SheetHeader>
                        ...
                        >
                          Make changes to your resume and job description
                          content.
                        </p>
                      </SheetHeader>
                      {editingResume ? (
                    ...
                    {isLoading ? (
                      ...
                      <div className="text-center py-8">
                        <p className="text-muted-foreground mb-4">
                          Failed to extract bullet points. Click below to try
                          again.
                        </p>
                      ...
                      bulletPoints && (
                        <>
                          ...
                          <BulletPointSection
                            ...
                            points={
                              bulletPoints.jobDescription.responsibilities
                            }
                          />
                          <BulletPointSection
                            title={
